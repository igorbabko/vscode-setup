...
if vim.g.vscode then
  ...
  local mappings = {
    -- Episode 1: Smart Word Navigation & Window Management (8 shortcuts)
    -- Navigate through camelCase and snake_case words + split/organize windows
    ...
    -- Episode 2: Code Navigation & Definition Jumping (9 shortcuts)
    -- Jump to definitions, implementations, references and navigate code structure
    ...
    -- Episode 3: Quick Search & Peek Actions (9 shortcuts)
    -- Find files, symbols instantly + peek definitions without navigation
    ...
    -- Episode 4: Find, Replace & Refactoring (8 shortcuts)
    -- Search, replace, rename variables and trigger refactoring tools
    ...
    -- Episode 5: Line Editing & Code Maintenance (8 shortcuts)
    -- Move/copy lines, format code, organize imports, navigate errors
    ...
    -- Episode 6: File & Workspace Management (9 shortcuts)
    -- Copy paths, manage files, workspace operations
